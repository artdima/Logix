...
class RequestDetailViewController: LogixBaseViewController {
    
    @IBOutlet weak var tableView: LogixTableView!
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "TextTableViewCell", bundle:LogixBundle.getBundle()), forCellReuseIdentifier: "TextTableViewCell")
        tableView.register(UINib(nibName: "ActionableTableViewCell", bundle:LogixBundle.getBundle()), forCellReuseIdentifier: "ActionableTableViewCell")
        tableView.register(UINib(nibName: "RequestTitleSectionView", bundle:LogixBundle.getBundle()), forHeaderFooterViewReuseIdentifier: "RequestTitleSectionView")
    }
    ...
    @objc func openActionSheet(_ sender: UIBarButtonItem){
        let ac = UIAlertController(title: "Logix", message: "Choose an option", preferredStyle: .actionSheet)
